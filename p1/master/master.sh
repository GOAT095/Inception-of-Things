...
curl -sfL https://get.k3s.io | INSTALL_K3S_EXEsdcC="$flags" K3S_NODE_NAME="anassifS" K3S_KUBECONFIG_MODE="644" sh - #K3S_KUBECONFIG_MODE for perm so its access rancher folder
